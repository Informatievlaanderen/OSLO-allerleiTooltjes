-- "Packages and Objects referenced per Diagram in Branch" (Branch gekozen in ProjectBrowser)

SELECT t_diagram.Diagram_ID, t_diagram.Name, t_package.Name, t_object.Name
FROM
...
ORDER BY t_diagram.Name, t_package.Name, t_object.Name